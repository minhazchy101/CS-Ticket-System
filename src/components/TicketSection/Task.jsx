...
const Task = ({tasks, handleResolved}) => {
    // console.log(tasks)
    return (
        <div className='mb-4'>
      ...
      <div className='mt-8 space-y-6'>
        {tasks.map((task)=>(
            ...
            <button onClick={()=>handleResolved(task)} className="bg-[#02A53B] hover:bg-[#02a53bc7] transition cursor-pointer px-6 py-2 font-medium rounded-md text-white text-sm w-full">
              Complete
            </button>
        </div>
        ))}
